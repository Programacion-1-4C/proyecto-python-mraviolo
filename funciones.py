...
pilotos = [
    Piloto('CARLOS SAINZ', '27', 'España, Madrid', 'Ferrari', '(1) victoria / (12) podios / (1) pole / (0) campeonatos'),
    Piloto('CHARLES LECRECR', '24', 'Monaco, Montecarlo', 'Ferrari', '(5) victoria / (18) podios / (16) pole / (0) campeonatos'),
    Piloto('MAX VERSTAPPEN', '24', 'Belgica, Hasselt', 'Red Bull', '(28) victoria / (70) podios / (16) pole / (1) campeonatos'),
    Piloto('SERGIO PEREZ', '32', 'Mexico, Guadalajara', 'Red Bull', '(3) victoria / (21) podios / (1) pole / (0) campeonatos'),
    Piloto('LEWIS HAMILTON', '37', 'Reino Unido, Stevenage', 'Mercedes', '(103) victoria / (188) podios / (103) pole / (7) campeonatos'),
    Piloto('GEORGE RUSSEL', '24', 'Reino Unido, Kings Lynn', 'Mercedes', '(0) victoria / (6) podios / (1) pole / (0) campeonatos'),
    Piloto('LANDO NORRIS', '22', 'Reino Unido, Bristol', 'McLaren', '(0) victoria / (6) podios / (1) pole / (0) campeonatos'),
    Piloto('DANIEL RICCIARDO', '33', 'Australia, Perth', 'McLaren', '(8) victoria / (32) podios / (3) pole / (0) campeonatos'),
    Piloto('ALEX ALBON', '26', 'Reino Unido, Londres', 'Williams', '(0) victoria / (2) podios / (0) pole / (0) campeonatos'),
    Piloto('NICOLAS LATIFI', '27', 'Canada, Montreal', 'Williams', '(0) victoria / (0) podios / (0) pole / (0) campeonatos'),
    Piloto('MICK SCHUMACHER', '23', 'Suiza, Genolier', 'Haas', '(0) victoria / (0) podios / (0) pole / (0) campeonatos'),
    Piloto('KEVIN MAGNUSSEN', '29', 'Dinamarca, Roskilde', 'Hass', '(0) victoria / (1) podios / (0) pole / (0) campeonatos'),
    Piloto('FERNANDO ALONSO', '41', 'España, Oviedo', 'Alpine', '(32) victoria / (98) podios / (22) pole / (2) campeonatos'),
    Piloto('ESTEBAN OCON', '25', 'Francia, Evreux', 'Alpine', '(1) victoria / (2) podios / (0) pole / (0) campeonatos'),
    Piloto('PIERRE GASLY', '26', 'Francia, Ruan', 'Alpha Tauri', '(1) victoria / (3) podios / (0) pole / (0) campeonatos'),
    Piloto('YUKI TSUNODA', '22', 'Japon, Sagamihara', 'Alpha Tauri', '(0) victoria / (0) podios / (0) pole / (0) campeonatos'),
    Piloto('VALTERI BOTTAS', '32', 'Finlandia, Nastola', 'Alfa Romeo', '(10) victoria / (67) podios / (20) pole / (0) campeonatos'),
    Piloto('GUANYU ZHOU', '23', 'China, Shanghai', 'Alfa Romeo', '(0) victoria / (0) podios / (0) pole / (0) campeonatos'),
    Piloto('SEBASTIAN VETTEL', '35', 'Alemania, Happenheim', 'Aston Martin', '(53) victoria / (122) podios / (57) pole / (4) campeonatos'),
    Piloto('LANCE STROLL', '23', 'Canada, Montreal', 'Aston Martin', '(0) victoria / (3) podios / (1) pole / (0) campeonatos')
]

# lista con todos los equipos 
equipos = [
    Equipo('FERRARI', 'La primera participación de Ferrari en Fórmula 1 fue en el Gran Premio de Mónaco de 1950, con el Tipo 125 F1. Ferrari es considerado uno de los cuatro grandes equipos de Fórmula 1. Ha contado con muchos de los pilotos más destacados de la historia de la Fórmula 1 como Michael Schumacher, Niki Lauda, Juan Manuel Fangio,Alberto Ascari, Alain Prost, Nigel Mansell, Carlos Reutemann, Gilles Villeneuve, Kimi Räikkönen, Sebastian Vettel y Fernando Alonso', 'Charles Lecrecr / Carlos Sainz', '(16) constructores / (15) pilotos / (773) podios / (240) victorias', 'Mattia Binotto'),
    Equipo('RED BULL', 'Red Bull Racing es una escudería austriaca de Fórmula 1 con base en Milton Keynes (Inglaterra), propiedad de la empresa de bebidas energéticas Red Bull. La compañía adquirió la escudería Jaguar Racing por cerca de 110 millones de dólares cuando la propietaria anterior de este equipo, Ford Motor Company, anunció su retirada de la máxima categoría del automovilismo. La empresa Red Bull posee un equipo filial de Fórmula 1, Scuderia AlphaTauri (conocida hasta 2019 como Scuderia Toro Rosso), con sede en Faenza (Italia), desde el que los jóvenes pilotos dan posteriormente el salto al primer equipo. Compite desde 2005 y en sus dos primeras temporadas corrió con licencia británica.', 'Max Verstappen / Sergio Perez', '(4) constructores / (5) pilotos / (221) podios / (84) victorias', 'Christian Horner'),
    Equipo('MERCEDES', 'Mercedes-Benz es una de las automotrices más exitosas de la Fórmula 1, considerada uno de los cuatro equipos con mejores resultados, junto con Williams, Ferrari y McLaren. Participó inicialmente como constructor en Fórmula 1 en 1954 y 1955, y volvió a hacerlo desde 2010 hasta la actualidad.', 'Lewis Hamilton / George Russel', '(8) constructores / (9) pilotos / (263) podios / (124) victorias', 'Torger Christian Wolff'),
    Equipo('MCLAREN', 'McLaren Racing Limited, conocida generalmente como McLaren, es una escudería británica de automovilismo con sede en Woking (Surrey, Inglaterra), fundada en 1963 por Bruce McLaren. Es considerado uno de los cuatro grandes equipos de Fórmula 1. ', 'Lando Norris / Daniel Ricciardo', '(12) constructores / (8) pilotos / (489) podios / (183) victorias', 'Zak Brown'),
    Equipo('WILLIAMS', 'Williams Grand Prix Engineering, comúnmente conocido como Williams, es un equipo de Fórmula 1 creado en 1977 por Frank Williams y Patrick Head. Es considerado uno de los cuatro grandes equipos de Fórmula 1, junto con Ferrari, McLaren y Mercedes. Ha ganado 9 campeonatos de constructores y 7 campeonatos de pilotos.', 'Nicolas Latifi / Alex Albon', '(9) constructores / (7) pilotos / (302) podios / (114) victorias', 'Simon Roberts'),
    Equipo('HAAS', 'Haas es la escudería más joven de la parrilla. Se constituyó en 2014 y empezó a competir en 2016. Debutó con un acuerdo de colaboración técnica con Dallara -que produjo su primer chasis- y Ferrari -que les permitió aprovechar algunos de sus componentes y recursos tecnológicos.', 'Kevin Magnussen / Mich Schumacher', '(0) constructores / (0) pilotos / (0) podios / (0) victorias', 'Guenther Steiner'),
    Equipo('ALPINE', 'Es propiedad de Renault, que compitió en la categoría reina bajo ese nombre hasta 2020. La marca Alpine, de coches deportivos y de competición, la fundó Jean Rédélé en 1955. La compañía cosechó una gran éxito con la comercialización del cupé deportivo A110, lanzado en 1961.', 'Fernando Alonso / Esteban Ocon', '(0) constructores / (0) pilotos / (2) podios / (1) victorias', 'Otmar Szafnauer'),
    Equipo('ALPHA TAURI', ' Es una escudería de Fórmula 1 que surgió a finales de 2005, después de la compra de la escudería Minardi por parte de Red Bull. Actuaba como equipo filial del equipo Red Bull Racing, formando jóvenes promesas para dar el salto a la escudería "madre"', 'Pierre Gasly / Tuki Tsunoda', '(0) constructores / (0) pilotos / (2) podios / (1) victorias', 'Franz Tost'),
